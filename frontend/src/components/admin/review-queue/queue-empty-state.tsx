...
export function QueueEmptyState({ hasFilters, onClearFilters }: QueueEmptyStateProps) {
  if (hasFilters) {
    return (
      <div className="flex flex-col items-center justify-center py-16 gap-4 rounded-xl border border-dashed border-border bg-card">
        ...
        <div className="text-center">
          <p className="text-sm font-semibold text-heading">No content matches your filters</p>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 gap-4 rounded-xl border border-dashed border-border bg-card">
      ...
      <div className="text-center">
        <p className="text-sm font-semibold text-heading">No content in this category</p>
        <p className="text-xs text-muted-foreground mt-1">
