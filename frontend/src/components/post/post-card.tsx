...
export function PostCard({ post }: PostCardProps) {
    ...
    return (
        <div className="card card-hover p-4 sm:p-5 flex flex-col gap-3 relative animate-in fade-in slide-in-from-bottom-2">
            ...
            <Link href={`/post/${post.id}`} className="block mt-1 group">
