...
export function CommentItem({ comment, currentUserId, currentUserAvatar, isDisabled, moderationStatus, communityId, canModerateCommunity, context = "personal" }: { comment: SelectCommentDTO, currentUserId: string, currentUserAvatar?: string, isDisabled?: boolean, moderationStatus?: ModerationStatus, communityId?: string | null, canModerateCommunity?: boolean, context?: "personal" | "community" }) {
