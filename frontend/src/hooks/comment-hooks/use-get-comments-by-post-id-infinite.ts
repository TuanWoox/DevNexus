...
export function useGetCommentsByPostIdInfinite(
    postId: string,
    ...
    return useInfiniteQuery({
        queryKey: [...commentQueryKeys.byPost(postId, mutablePayload as any), "infinite"],
        queryFn: ({ pageParam = 0 }) =>
            commentService.getCommentsByPostId(postId, {
                ...mutablePayload,
                size: 20, // default size or you could pass it
