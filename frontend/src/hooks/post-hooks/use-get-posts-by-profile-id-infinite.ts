...
export function useGetPostsByProfileIdInfinite(
    profileId: string,
    ...
    return useInfiniteQuery({
        queryKey: postQueryKeys.list({ ...mutablePayload, profileId, type: 'posts', infinite: true }),
        queryFn: ({ pageParam = 0 }) =>
            postService.getPostsByProfileId(profileId, {
                ...mutablePayload,
