...
export function useGetSentFollowRequests(searchTerm: string = "") {
  return useInfiniteQuery({
    queryKey: followRequestQueryKeys.sentList(searchTerm),
    queryFn: ({ pageParam = 0 }) => {
      ...
      return followRequestService.getSentRequests(page);
    },
