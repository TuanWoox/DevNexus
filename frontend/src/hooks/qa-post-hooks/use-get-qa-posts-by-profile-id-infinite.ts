...
export function useGetQAPostsByProfileIdInfinite(
    profileId: string,
    ...
    return useInfiniteQuery({
        queryKey: qaPostQueryKeys.list({ ...mutablePayload, profileId, type: 'qa-posts', infinite: true }),
        queryFn: ({ pageParam = 0 }) =>
            qaPostService.getQAPostsByProfileId(profileId, {
                ...mutablePayload,
