...
export function useGetRecommendedQAPostsInfinite(
    ...
    return useInfiniteQuery({
        queryKey: recommendationQueryKeys.qaFeed({ ...mutablePayload, infinite: true }),
        queryFn: ({ pageParam = 0 }) =>
            recommendationService.getPersonalizedQAPostFeed({
                ...mutablePayload,
