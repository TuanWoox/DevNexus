...
export const useContactProfilesSearch = (query: string) => {
    ...
    return useInfiniteQuery({
        queryKey: messagingQueryKeys.contactSearch(debouncedQuery),
        queryFn: ({ pageParam = 1 }) => {
            ...
            return profileService.searchContactProfiles(page);
        },
        initialPageParam: 1,
